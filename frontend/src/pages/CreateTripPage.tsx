...
const citySuggestions: Record<string, ActivitySuggestion[]> = {
  'Paris': [
    ...
    { id: 'par-3', name: 'Seine River Cruise & Dinner', category: 'Food', cost: 95, duration: '2.5 hours', image: 'https://images.unsplash.com/photo-1549146473-3c971f9412c3?auto=format&fit=crop&w=500&q=80', description: 'Dine on classic French cuisine while cruising past illuminated monuments.' },
  ...
  'Tokyo': [
    { id: 'tok-1', name: 'Shibuya Crossing & Foodie Walk', category: 'Food', cost: 55, duration: '3 hours', image: 'https://images.unsplash.com/photo-1540959733332-eab4deceeaf7?auto=format&fit=crop&w=500&q=80', description: 'Navigate the world\'s busiest crossing and taste local yakitori.' },
  ...
  'New York': [
    ...
    { id: 'nyc-3', name: 'Central Park Bicycle Rental & Tour', category: 'Adventure', cost: 30, duration: '2 hours', image: 'https://images.unsplash.com/photo-1522083165195-3427ec02927a?auto=format&fit=crop&w=500&q=80', description: 'Cycle past Bethesda Fountain, Strawberry Fields, and Belvedere Castle.' },
  ...
  'Rome': [
    ...
    { id: 'rom-2', name: 'Vatican Museums & Sistine Chapel', category: 'Culture', cost: 42, duration: '4 hours', image: 'https://images.unsplash.com/photo-1529260830199-4455210982ba?auto=format&fit=crop&w=500&q=80', description: 'Admire Michelangelo\'s masterpiece and the treasures of the Holy See.' },
