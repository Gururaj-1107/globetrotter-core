...
async function main() {
  ...
  const activitiesData = [
    ...
    { id: 'tok-3', cityId: 'tokyo', name: 'Mount Fuji Day Trip & Hakone Cable Car', category: 'Adventure', cost: 120, duration: '8 hours', rating: 4.9, imageUrl: 'https://images.unsplash.com/photo-1540959733332-eab4deceeaf7?auto=format&fit=crop&w=600&q=80', description: 'Panoramic vistas of the sacred volcano with Lake Ashi cruise.' },
